    ...
    <section id="adriana" class="recursos">
        ...
        <section class="recursos_internos">
            ...
            <dl class="recursos_internos">
                ...
                <dt>Newsletter - cadastre-se para receber as novidades</dt>
                ...
                <dd>
                    <p>A nova política de cupons da Udemy não permite mais criar cupons vitalícios, eles agora têm
                        validade de no máximo 30 dias. Por isso, minha estratégia de cupons foi alterada. Para ficar por dentro e continuar recebendo os cupons com as promoções de 5 dias com melhor preço, por favor <a href="https://www.subscribepage.com/Cbbrnewsletter" target="_blank"
                       alt="Link para se cadastrar no Newsletter">inscreva-se no Newsletter</a>.</p>

                    <p>Além, disso, todo mês eu criarei um cupom com o nome do mês e os últimos dois dígitos do ano, por exemplo:
                        <strong>JUNHO20</strong>. Então você poderá colocar o cupom dessa maneira dependendo do mês e
                        ano da compra.</p>
